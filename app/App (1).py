...
connection = pymysql.connect(
    host='localhost',          # localhost (host máy bạn)
    port=3306,                 # c�~Ung expose từ docker-compose
    user='user_cv',            # user bạn khai báo trong compose
    password='userpass123',    # mật khẩu user �~Qó
    database='cv',             # database mặc �~Q�~Knh tạo sẵn
    charset='utf8mb4',
